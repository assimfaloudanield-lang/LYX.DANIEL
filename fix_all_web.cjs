...
const newLayout = `  return (
    <div className="relative min-h-[100dvh] w-full overflow-hidden bg-black font-sans flex flex-col justify-between py-6 px-5 sm:px-8">
      ...
      {/* 2. ESPAÇO E LOGO */}
      <div className="relative z-20 flex flex-col items-center justify-end pointer-events-none flex-1 pb-4">
        <img
          id="app-main-logo"
          src="./Logotipolyx.png"
          alt="Logotipo LYX"
          className="w-[260px] sm:w-[300px] max-w-[80%] h-auto object-contain drop-shadow-[0_10px_32px_rgba(0,0,0,0.85)] select-none mb-0"
        />
      </div>
      ...
      <div className="relative z-30 flex flex-col items-center w-full pointer-events-auto gap-4 pb-2">
        ...
        <div className="flex flex-col items-center justify-center pointer-events-auto mb-2 mt-2">
          <IPhonePowerButton
            isOn={isOn}
        ...
        >
          ...
          <div className="relative flex items-center justify-between px-5 py-2.5 rounded-full bg-[#0A061C]/30 backdrop-blur-xl text-left overflow-hidden border-[0.5px] border-white/5">
            {/* Noise SVG overlay */}
            ...
            <div className="flex items-center gap-3 relative z-10">
              <div className="w-8 h-8 rounded-full flex items-center justify-center bg-white/[0.05] border-[0.5px] border-[#818CF8]/30">
        ...
        <div className="relative mt-3 w-full max-w-[280px]">
          ...
          <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 z-10 w-7 h-7 rounded-full bg-gradient-to-b from-slate-900 to-black border-[0.5px] border-[#818CF8]/40 flex items-center justify-center shadow-[0_4px_10px_rgba(0,0,0,0.5)]">
             <Lock size={12} className="text-white/70 outline-none" strokeWidth={2} />
          </div>
          
          {/* Card Glass */}
          <div className="w-full rounded-[20px] bg-white/[0.01] border-[0.5px] border-[#818CF8]/20 backdrop-blur-xl pt-5 pb-3 px-4 flex flex-col items-center shadow-[0_8px_32px_rgba(0,0,0,0.3)] relative overflow-hidden">
             {/* Noise SVG */}
...
console.log('App.tsx totally updated with new layout');
