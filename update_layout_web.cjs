...
// We will use regex or precise slice to replace the layout from "{/* 2. ESPAÇO E LOGO */}" to the end of the return statement.
const startIdx = code.indexOf('{/* 2. ESPAÇO E LOGO */}');
const endIdx = code.indexOf('    </div>\n  );\n};');

const newLayout = `{/* 2. ESPAÇO E LOGO */}
      ...
      <div className="relative z-30 flex flex-col items-center w-full pointer-events-auto gap-4 pb-2">
        ...
        >
          ...
          <div className="relative flex items-center justify-between px-5 py-2.5 rounded-full bg-white/[0.03] backdrop-blur-3xl text-left overflow-hidden">
            {/* Noise SVG overlay */}
        ...
        <div className="relative mt-3 w-full max-w-[280px]">
          ...
          {/* Card Glass */}
          <div className="w-full rounded-[18px] bg-white/[0.02] border-[0.5px] border-white/10 backdrop-blur-xl pt-5 pb-3 px-4 flex flex-col items-center shadow-lg relative overflow-hidden">
             {/* Noise SVG */}
        ...
        {/* PROGRESS BAR */}
        <div className="w-full max-w-[280px] mt-2 mb-2 p-3.5 rounded-[16px] bg-white/[0.02] border-[0.5px] border-white/10 backdrop-blur-md flex flex-col gap-2.5">
...
console.log('Layout updated in Web');
